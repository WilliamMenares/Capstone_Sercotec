...
class WelcomeController extends Controller
{
    public function index()
    {
        ...
        if ($ultimasEmpresas->isEmpty()) {
            $ultimasEmpresas = collect(); // Crear una colección vacía
        }
        ...
        // Verificar si hay empresas en los últimos 6 meses
        if ($empresasUltimos6Meses->isEmpty()) {
            $empresasUltimos6Meses = collect(); // Crear una colección vacía
        }
