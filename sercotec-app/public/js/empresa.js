document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('[id^="modalEditar"]').forEach(function (modalEditar) {
    ...
    if (rutEditarInput) {
     ...
     function formatTelefono(telefono) {
        ...
        if (telefono.length > 4) {
            return `+${telefono.slice(0, 2)} ${telefono.slice(2, 3)} ${telefono.slice(3, 7)} ${telefono.slice(7, 11)}`;
        }
